...
fasta2DNAbin reads in alignments in fasta format and outputs a DNAbin object. This output contains alignments or SNPs. This function is used through the ape project. 
```{r}
...
![UVRAG sublconed into UVRAG](../images/pGL3UVRAG.jpeg)
...
The Homo Sapiens share similar conservation with *Peromyscus maniculatus*. Each node depicts the similar common ancestor of the species. Although this is preliminary data and is subject to change as further research is conducted on the promoter region and its expression and activity. A good starting point leading to possible further directions when studying the putative promoter region. 
